...
namespace Lime
{
	public class FontBuilder
	{
		...
		public readonly int TextureSize = 1024;
		public int Height { get; private set; }
		public readonly string Characters;
		private byte[] fontData;

		/// <summary>
		/// Initializes a new instance of the <see cref="Lime.RichUI.FontBuilder"/> class.
		/// </summary>
		/// <param name="fontData">Font file.</param>
		/// <param name="height">Font height, measured as a distance between two text lines in the device pixels.</param>
		/// <param name="characters">List of characters.</param>
		public FontBuilder(byte[] fontData, int height, string characters = null)
		{
