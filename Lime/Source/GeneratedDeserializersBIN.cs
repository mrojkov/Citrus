...
;				fd = def.Fields[d.Reader.ReadInt16()];
			...
			if (16 == fd.OurIndex) {
				...
				var tmp14 = new global::Lime.Thickness();
				tmp14.Left = d.Reader.ReadSingle();
				tmp14.Right = d.Reader.ReadSingle();
				tmp14.Top = d.Reader.ReadSingle();
				tmp14.Bottom = d.Reader.ReadSingle();
				result.Padding = tmp14
;				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (17 == fd.OurIndex) {
				dg.EnsureClassDef(typeof(global::Lime.Vector2));
...
;				fd = def.Fields[d.Reader.ReadInt16()];
		...
		private static void Read_Lime__HBoxLayout(BinaryDeserializer d, ReaderClassDef def, object obj)
		{
			...
			fd = def.Fields[d.Reader.ReadInt16()];
			if (1 == fd.OurIndex) {
				result.CellDefaults = (global::Lime.LayoutCell)dg.ReadObject<global::Lime.LayoutCell>();
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (2 == fd.OurIndex) {
...
;				fd = def.Fields[d.Reader.ReadInt16()];
		...
		private static void Read_Lime__LightSource(BinaryDeserializer d, ReaderClassDef def, object obj)
		{
			...
			fd = def.Fields[d.Reader.ReadInt16()];
			if (1 == fd.OurIndex) {
				result.Ambient = d.Reader.ReadSingle();
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (2 == fd.OurIndex) {
				var tmp1 = d.Reader.ReadInt32();
...
;				fd = def.Fields[d.Reader.ReadInt16()];
			...
			if (9 == fd.OurIndex) {
				result.Intensity = d.Reader.ReadSingle();
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (10 == fd.OurIndex) {
				var tmp10 = d.Reader.ReadInt32();
...
;				fd = def.Fields[d.Reader.ReadInt16()];
			...
			if (15 == fd.OurIndex) {
				dg.EnsureClassDef(typeof(global::Lime.Color4));
				var tmp15 = new global::Lime.Color4();
				tmp15.ABGR = d.Reader.ReadUInt32();
				result.ShadowColor = tmp15
;				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (16 == fd.OurIndex) {
				result.ShadowMapProjectionSize = d.Reader.ReadSingle();
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (17 == fd.OurIndex) {
				result.ShadowMapProjectionZFar = d.Reader.ReadSingle();
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (18 == fd.OurIndex) {
				result.ShadowMapProjectionZNear = d.Reader.ReadSingle();
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (19 == fd.OurIndex) {
				result.ShadowMapQuality = (global::Lime.ShadowMapTextureQuality)d.Reader.ReadInt32();
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (20 == fd.OurIndex) {
				result.ShadowMappingEnabled = d.Reader.ReadBoolean();
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (21 == fd.OurIndex) {
		...
		private static object Make_Lime__LightSource(BinaryDeserializer d, ReaderClassDef def)
		{
...
;				fd = def.Fields[d.Reader.ReadInt16()];
			...
			if (9 == fd.OurIndex) {
				result.LightningEnabled = d.Reader.ReadBoolean();
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (10 == fd.OurIndex) {
				var tmp10 = d.Reader.ReadInt32();
...
;				fd = def.Fields[d.Reader.ReadInt16()];
			...
			if (13 == fd.OurIndex) {
				result.RecieveShadow = d.Reader.ReadBoolean();
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (14 == fd.OurIndex) {
				dg.EnsureClassDef(typeof(global::Lime.Quaternion));
...
;				fd = def.Fields[d.Reader.ReadInt16()];
		...
		private static void Read_Lime__Model3DAttachmentParser__ModelAttachmentFormat(BinaryDeserializer d, ReaderClassDef def, object obj)
		{
			...
			if (2 == fd.OurIndex) {
				result.MaterialEffects = (global::System.Collections.Generic.Dictionary<global::System.String,global::Lime.Model3DAttachmentParser.ModelMaterialEffectFormat>)null;
				var tmp4 = d.Reader.ReadInt32();
				if (tmp4 >= 0) {
					result.MaterialEffects = new global::System.Collections.Generic.Dictionary<global::System.String,global::Lime.Model3DAttachmentParser.ModelMaterialEffectFormat>();
					while (--tmp4 >= 0) {
						var tmp5 = d.Reader.ReadString();
						if (tmp5 == "" && d.Reader.ReadBoolean()) tmp5 = null;
						var tmp6 = (global::Lime.Model3DAttachmentParser.ModelMaterialEffectFormat)dg.ReadObject<global::Lime.Model3DAttachmentParser.ModelMaterialEffectFormat>();
						result.MaterialEffects.Add(tmp5, tmp6);
					}
				}
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (3 == fd.OurIndex) {
				...
				if (tmp7 >= 0) {
					...
					while (--tmp7 >= 0) {
						...
						var tmp9 = (global::Lime.Model3DAttachmentParser.MeshOptionFormat)dg.ReadObject<global::Lime.Model3DAttachmentParser.MeshOptionFormat>();
						result.MeshOptions.Add(tmp8, tmp9);
					}
				}
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			...
			if (5 == fd.OurIndex) {
				...
				if (tmp10 >= 0) {
					...
					while (--tmp10 >= 0) {
						var tmp11 = (global::Lime.Model3DAttachmentParser.UVAnimationFormat)dg.ReadObject<global::Lime.Model3DAttachmentParser.UVAnimationFormat>();
						result.UVAnimations.Add(tmp11);
					}
				}
				fd = def.Fields[d.Reader.ReadInt16()];
			}
		...
		private static void Read_Lime__Model3DAttachmentParser__ModelMaterialEffectFormat(BinaryDeserializer d, ReaderClassDef def, object obj)
		{
			var result = (global::Lime.Model3DAttachmentParser.ModelMaterialEffectFormat)obj;
			var dg = (BinaryDeserializerGen)d;
			ReaderClassDef.FieldDef fd;
			fd = def.Fields[d.Reader.ReadInt16()];
			if (1 == fd.OurIndex) {
			...
			if (2 == fd.OurIndex) {
				result.MaterialName = d.Reader.ReadString();
				if (result.MaterialName == "" && d.Reader.ReadBoolean()) result.MaterialName = null;
				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (3 == fd.OurIndex) {
		...
		private static object Make_Lime__Model3DAttachmentParser__ModelMaterialEffectFormat(BinaryDeserializer d, ReaderClassDef def)
		{
			var result = new global::Lime.Model3DAttachmentParser.ModelMaterialEffectFormat();
			Read_Lime__Model3DAttachmentParser__ModelMaterialEffectFormat(d, def, result);
			return result;
		}
...
;				fd = def.Fields[d.Reader.ReadInt16()];
			...
			if (34 == fd.OurIndex) {
				dg.EnsureClassDef(typeof(global::Lime.Color4));
				var tmp19 = new global::Lime.Color4();
				tmp19.ABGR = d.Reader.ReadUInt32();
				result.TextColor = tmp19
;				fd = def.Fields[d.Reader.ReadInt16()];
			}
			if (35 == fd.OurIndex) {
				result.VAlignment = (global::Lime.VAlignment)d.Reader.ReadInt32();
...
;				fd = def.Fields[d.Reader.ReadInt16()];
		...
		static BinaryDeserializerGen()
		{
			...
			readCache[typeof(global::Lime.Model3DAttachmentParser.ModelMaterialEffectFormat)] = Read_Lime__Model3DAttachmentParser__ModelMaterialEffectFormat;
			...
			makeCache[typeof(global::Lime.Model3DAttachmentParser.ModelMaterialEffectFormat)] = Make_Lime__Model3DAttachmentParser__ModelMaterialEffectFormat;
