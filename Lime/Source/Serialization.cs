...
namespace Lime
{
	public static class Serialization
	{
		...
		public static void WriteObject<T>(string path, Stream stream, T instance, Format format)
		{
			...
			try {
				if (format == Format.Binary) {
					...
					ys = new Yuzu.Json.JsonSerializer(); //yuzuJsonSerializer;
				}
		...
		public static T ReadObject<T>(string path, Stream stream, object obj = null) where T : new()
		{
		...
		private static Yuzu.Json.JsonSerializeOptions defaultYuzuJSONOptions = new JsonSerializeOptions {
