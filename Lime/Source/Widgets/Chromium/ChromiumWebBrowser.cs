...
namespace Lime.Chromium
{
	...
	public class ChromiumWebBrowser : IRenderWebBrowser
	{
		...
		public ChromiumWebBrowser(int width = 1366, int height = 768, string address = "",
		...
		void IRenderWebBrowser.SetCursor(IntPtr handle, CefCursorType type)
		{
			switch (type) {
				...
				case CefCursorType.IBeam: {
					GameView.Instance.SetCursor("Cursors.IBeam.png", new IntVector2(6, 8), "Lime");
					break;
				}
				case CefCursorType.Hand: {
					GameView.Instance.SetCursor("Cursors.Hand.png", new IntVector2(7, 2), "Lime");
					break;
				}
			}
		}
