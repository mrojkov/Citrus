namespace GoogleMarketExpansionDownloader
{
    ...
    [Activity(Label = "GoogleMarketExpansionDownloaderActivity", MainLauncher = true, Icon = "@drawable/Icon", NoHistory = true)]
    public class DownloaderActivity : Activity, IDownloaderClient
    {
