...
API bool C_DECL ParseShader(ShaderHandle shaderHandle, ShaderStage stage, const char* source);
...
API bool C_DECL LinkProgram(ProgramHandle programHandle, ShaderHandle vertexShaderHandle, ShaderHandle fragmentShaderHandle);
