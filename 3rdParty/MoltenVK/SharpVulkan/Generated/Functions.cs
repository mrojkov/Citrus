...
namespace SharpVulkan
{
    ...
    {
		// internal const string LibraryName = "MoltenVK";
#if  __IOS__
		internal const string LibraryName = "__Internal";
#else
		internal const string LibraryName = "vulkan.1.1.82";
#endif
    ...
    public partial struct Instance
    {
        ...
        public unsafe Surface CreateMacOSSurface(ref MacOSSurfaceCreateInfo createInfo, AllocationCallbacks* allocator = null)
        {
            Surface surface;
            fixed (MacOSSurfaceCreateInfo* __createInfo__ = &createInfo)
            {
                vkCreateMacOSSurfaceMVK(this, __createInfo__, allocator, &surface).CheckError();
            }
            return surface;
        }
        ...
        [DllImport(Vulkan.LibraryName, CallingConvention = CallingConvention.StdCall)]
        [SuppressUnmanagedCodeSecurity]
        internal static extern unsafe Result vkCreateMacOSSurfaceMVK(Instance instance, MacOSSurfaceCreateInfo* createInfo, AllocationCallbacks* allocator, Surface* surface);

        public unsafe Surface CreateIOSSurface(ref IOSSurfaceCreateInfo createInfo, AllocationCallbacks* allocator = null)
        {
            Surface surface;
            fixed (IOSSurfaceCreateInfo* __createInfo__ = &createInfo)
            {
                vkCreateIOSSurfaceMVK(this, __createInfo__, allocator, &surface).CheckError();
            }
            return surface;
        }
        ...
        [DllImport(Vulkan.LibraryName, CallingConvention = CallingConvention.StdCall)]
        [SuppressUnmanagedCodeSecurity]
        internal static extern unsafe Result vkCreateIOSSurfaceMVK(Instance instance, IOSSurfaceCreateInfo* createInfo, AllocationCallbacks* allocator, Surface* surface);
