...
* Исправлена ошибка, приводящая к крашу при выборе списка из выпадающего списка листов [CIT-1081](https://gitlab.game-forest.com:2000/browse/CIT-1081)
...
* Исправлена ошибка, не позволяющая изменять значение Color у нескольких выбранных виджетов, если они имели различные значения данного параметра [CIT-1022](https://gitlab.game-forest.com:2000/browse/CIT-1022)

##### Changelog 26.12.2018

* Реализована возможность отображать предупреждения и ошибки прямо в панели Inspector [CIT-1016](https://gitlab.game-forest.com:2000/browse/CIT-1016)

Багфиксы:

* Исправлена ошибка, позволяющая случайно зайти в контейнер при изменении значения в инспекторе [CIT-783](https://gitlab.game-forest.com:2000/browse/CIT-783)
* Исправлена ошибка, приводящая к крашу, если введенное значение Color было больше 4 байт [CIT-1034](https://gitlab.game-forest.com:2000/browse/CIT-1034)
...
* Для кнопок в играх и редакторе теперь можно задавать доп. лимиты, где кнопка считается нажатой [CIT-902](https://gitlab.game-forest.com:2000/browse/CIT-902)
* Реализована возможность использовать SDF-шрифты в RichText и SimpleText [CIT-929](https://gitlab.game-forest.com:2000/browse/CIT-929)

Багфиксы:

* Исправлена ошибка, приводящая к невозможности снять выделение с отдельного фрейма, используя Ctrl [CIT-967](https://gitlab.game-forest.com:2000/browse/CIT-CIT-967)
...
* Исправлена ошибка, приводящая к необновляемым значениями в инспекторе [CIT-973](https://gitlab.game-forest.com:2000/browse/CIT-973)
