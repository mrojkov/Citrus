...
namespace Tangerine.UI
{
	public static class TimelineCommands
	{
		...
		public static readonly ICommand CreateAnimationClip = new Command("Create Animation Clip");
		public static readonly ICommand SplitAnimationClip = new Command("Split Animation Clip");
	}
	...
	public static class GenericCommands
	{
		...
		public static readonly ICommand NewScene = new Command("New Scene");
		public static readonly ICommand NewTan = new Command("New Tan", new Shortcut(Modifiers.Command, Key.N));
