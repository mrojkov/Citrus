...
typedef struct {
    int             width;  /**< Width of the Y' luminance plane */
    int             height; /**< Height of the luminance plane */
    int             stride; /**< Offset in bytes between successive rows */
    unsigned short *data;   /**< Pointer to start of luminance data */
} rgb565_buffer;
